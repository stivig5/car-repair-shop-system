...
import { 
    LayoutDashboard, Car, Wrench, Package, CalendarDays, 
    Settings, LogOut 
} from "lucide-react";
        ...
        <div className="flex h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-700 font-sans">
            <aside className="w-72 bg-[#0f172a] text-white hidden md:flex flex-col z-20 shadow-xl">
                ...
                <nav className="flex-1 py-6 space-y-1 overflow-y-auto custom-scrollbar">
                    <NavItem to="/mechanic/dashboard" label="Pulpit" icon={LayoutDashboard} />
                    <NavItem to="/mechanic/cars" label="Pojazdy" icon={Car} />
                    <NavItem to="/mechanic/orders" label="Zlecenia" icon={Wrench} />
                    <NavItem to="/mechanic/inventory" label="Magazyn" icon={Package} />
                    <NavItem to="/mechanic/appointments" label="Kalendarz" icon={CalendarDays} />
                </nav>
